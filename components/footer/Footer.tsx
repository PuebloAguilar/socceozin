...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-white/20 bg-black text-white transition-colors duration-300">
      <div className="container mx-auto px-4 py-12 md:px-6 lg:px-8">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div className="relative">
            ...
            <form className="relative">
              <Input
                ...
                className="pr-12 backdrop-blur-sm select-text"
              />
              <Button
                type="submit"
                size="icon"
          ...
          <div>
            ...
            <address className="space-y-2 text-sm not-italic text-neutral-400">
              ...
              <p>Email: ola@socceo.com</p>
            </address>
          </div>
          <div className="relative">
            <h3 className="mb-4 text-lg font-semibold">Siga-nos</h3>
            {/* FIX: Wrapped all Tooltip components in a single TooltipProvider. This aligns with standard React provider patterns and resolves TypeScript errors about missing children, likely caused by an unconventional structure with multiple providers. */}
            <TooltipProvider>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-white/20 pt-8 text-center md:flex-row">
          <p className="text-sm text-neutral-500">
            © 2024 Socceo. Todos os direitos reservados.
          </p>
